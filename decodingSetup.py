...
def get_neuronRepeats(linenum):
    ...
    if not os.path.isfile(cwd+'/datasets/datasplit-'+str(sess)+'-nm'+str(nm)+'-nf'+str(nf)+'.pickle'):
        ...
        with open(cwd+'/datasets/datasplit-'+str(sess)+'-nm'+str(nm)+'-nf'+str(nf)+'.pickle','wb') as f:
