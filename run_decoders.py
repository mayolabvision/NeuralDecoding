...
def baselineMetrics(y_train, y_train_predicted, y_test, *predictions):
    metrics = []
...
def fitModel(model,Xtr,ytr,t1,Xte,yte,y_base_predicted):
    ...
    return (y_train_predicted, y_test_predicted, y_shuf_predicted, y_mean_predicted, y_base_predicted) + baselineMetrics(ytr, y_train_predicted, yte, y_test_predicted, y_shuf_predicted, y_mean_predicted, y_base_predicted) + (train_time, test_time)
