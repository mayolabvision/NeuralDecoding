...
for j, job in enumerate(job_arr):
    ...
    vae_results = train_vae(X_flat_train, y_train, X_flat_valid, y_valid, X_flat_test, y_test, latent_dim=10, epochs=100)
    print(vae_results)
    print(asdlkjadsflk)
    ##############################
